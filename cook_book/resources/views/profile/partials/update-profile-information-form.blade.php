                ...
                <div class="mt-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <button form="send-verification" class="text-sm text-yellow-700 hover:text-yellow-900 underline font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-md" style="--tw-ring-color: #6A994E;">
